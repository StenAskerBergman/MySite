   ...
   <body>
      ...
      <div class="tab-content" id="pills-tabContent">
         <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
               <li class="nav-item">
                  <a class="nav-link activ" id="pills-Recent-tab" data-toggle="pill" href="#pills-Recent" role="tab" aria-controls="pills-Recent" aria-selected="true">Recent Work</a>
               </li>
                 <li class="nav-item">
                    <a class="nav-link disabled" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"></a>
                 </li>
               <li class="nav-item">
                  <a class="nav-link" id="pills-Process-tab" data-toggle="pill" href="#pills-Process" role="tab" aria-controls="pills-Process" aria-selected="false">My Process</a>
               </li>
            </ul>
            </div>
            <!-- Options --> <!-- First -->
            ...
            <?php // First Page - Post Content ?>
                    <div class="container" style="background-color: var(--shift-bg-color);">
                       ...
                       <div class="albums" id="NTP" style="background-color: var(--shift-bg-color);">
                          <div class="container">
                            <?php // Post Row 1 ?>
                              <div class="card shadow" id="GameRed">
                                <div  id="boxy">
